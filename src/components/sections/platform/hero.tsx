  ...
  return (
    <section className="relative overflow-hidden pt-[clamp(120px,16vh,180px)] pb-[clamp(56px,8vw,96px)]">
      ...
      <div className="mx-auto grid w-[min(1360px,100%-2*clamp(20px,4vw,64px))] items-center gap-10 lg:grid-cols-[minmax(0,.92fr)_minmax(420px,1.08fr)] lg:gap-14">
        ...
        <Reveal delay={140} className="relative justify-self-end w-full max-w-[700px] [perspective:1000px]" onPointerMove={handlePointerMove} onPointerLeave={resetAvatar}>
          ...
          <div ref={avatarRef} className="absolute top-[7%] left-[2%] z-10 w-[clamp(7.5rem,15vw,12rem)] overflow-hidden rounded-[22px] border border-white/60 bg-white shadow-[0_24px_45px_rgba(0,0,0,.28)] [transform-style:preserve-3d]">
